    ...
    $sql = "SELECT id,nom From evenement";
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            if(empty($_POST['eventName'])){
                ...
                $eventChoose = trojan($_POST['eventName']);
            }
            ...
            if($erreur == false){
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST")
                {
                    ...
                    $sql = "UPDATE evenement SET moment='$dateTime', lieu='$lieu', departement='$departement' WHERE id='$eventName'";
    ...
    <div id="container">
        ...
        <?php
            ...
            if ($result->num_rows > 0) {          
                ?>
                    <p>Évènement à modifier:</p>
                        <select id="eventName" name="eventName" size="1" style="width: 200px; font-size: 14pt;">
